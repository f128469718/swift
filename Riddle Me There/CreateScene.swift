...
class CreateScene: SKScene {
 ...
 override func didMove(to view: SKView) {
    ...
    submitbutton.addTarget(self,action: #selector(clickButton),for: .touchUpInside)//修改按鈕細節
    ...
    camerabutton.addTarget(self,action: #selector(clickButton1),for: .touchUpInside)//修改按鈕細節
