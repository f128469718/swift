...
<<<<<<< HEAD:Riddle Me There/AreaScene.swift
...
=======
    ...
    var mapbtn : UIButton!
    var returnbtn : UIButton!
>>>>>>> 05c0fbb4c78064bff04d37b066898d956ff69f95:Riddle Me There/Area/AreaScene.swift
    ...
    override func didMove(to view: SKView) {
        ...
        pos.autoPosition(item1: specialriddlesbtn, item2: sView!, topValue: view.bounds.height * 0.67, bottomValue: -(view.bounds.height * 0.33), leftValue: view.bounds.width * 0.75, rightValue: -(view.bounds.width * 0.25), widthValue: 0.21, heightValue: 0.12)
            
        pos.autoPosition(item1: mapbtn, item2: sView!, topValue: view.bounds.height * 0.8, bottomValue: -(view.bounds.height * 0.2), leftValue: view.bounds.width * 0.8, rightValue: -(view.bounds.width * 0.2), widthValue: 0.12, heightValue: 0.13)
